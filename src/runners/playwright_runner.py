"""
PLAYWRIGHT RUNNER - Minimal Stealth, Maximum Speed

This runner uses vanilla Playwright with minimal stealth for:
- Fast execution
- Simple configuration
- Reliable page loading
- Testing and development

Best for: Speed, simplicity, development testing
"""
...
class PlaywrightRunner(BaseRunner):
    """Vanilla Playwright runner with minimal stealth"""
    
    def __init__(self, screenshot_engine=None):
        super().__init__(screenshot_engine)
        logger.info("Playwright runner initialized (minimal stealth, fast)")
    ...
    async def run_test(
        ...
        """Run test with vanilla Playwright + minimal stealth"""
    ...
    async def _apply_minimal_stealth(self, context):
        ...
        This is the simplest approach that allows pages to load naturally.
        """
        script = """
(function() {
    'use strict';
