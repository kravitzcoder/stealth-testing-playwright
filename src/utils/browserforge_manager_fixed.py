"""
BrowserForge Integration Manager with Native WebRTC Support (FIXED)
...
class BrowserForgeManager:
    ...
    def get_browserforge_webrtc_script(self, enhanced_config: Dict[str, Any]) -> str:
        ...
        This method is called by enhanced runners to get just the WebRTC part
        ...
        # Return the WebRTC masking script
    ...
    def _build_webrtc_script(self, proxy_ip: str) -> str:
        ...
        Args:
            proxy_ip: Proxy IP address to show instead of real IPs
...
"""
    ...
    def _build_injection_script(self, fingerprint, enhanced_config: Dict[str, Any]) -> str:
        ...
        # Build WebGL script if available
        webgl_script = ""
